-- Supprime les anciens triggers/fonctions
DROP TRIGGER IF EXISTS after_tenant_insert ON tenants;
DROP FUNCTION IF EXISTS insert_default_categories();
DROP TRIGGER IF EXISTS after_category_insert ON salon_categories;
DROP FUNCTION IF EXISTS insert_preset_services();

-- Fonction d'insertion des catégories par défaut
...
-- Fonction d'insertion des services prédéfinis
